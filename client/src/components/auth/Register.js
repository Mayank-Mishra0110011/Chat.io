							...
							<div className="col-lg-11 col-md-11 col-sm-10 col-12">
								<form onSubmit={this.onSubmit} noValidate>
									<div className="form-group pb-2">
										<label htmlFor="email" className="text-muted" style={{ fontWeight: 'bold' }}>
											Email
										</label>
										<input
									...
									<div className="form-group">
										<label htmlFor="username" className="text-muted" style={{ fontWeight: 'bold' }}>
											Username
										</label>
										<input
											className={classnames('form-control finput', {
									...
									<div className="form-group">
										<label htmlFor="password" className="text-muted" style={{ fontWeight: 'bold' }}>
											Password
										</label>
										<input
											className={classnames('form-control finput', {
